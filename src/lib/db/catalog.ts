...
export const DB_COLLECTIONS: DbCollection[] = [
  ...
  { name: "groupJoinRequests", pk: "id", service: "groups", owner: "shared-public", lifecycle: "ttl", notes: "درخواست عضویت؛ Approve/Reject/Cancel سمت سرور." },
  { name: "channelPosts", pk: "id", fks: [{ field: "channelId", collection: "pubChannels", onDelete: "cascade-owner" }], service: "channels", owner: "shared-public", lifecycle: "hot", notes: "فایل کانال متادیتا؛ بایت در پست. Silent بدون اعلان." },
