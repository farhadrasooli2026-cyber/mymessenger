...
export function nixoLocalReply(text: string): string {
  ...
  if (/گروه|کانال|فروش|کیف|پرداخت|ai|ربات|بلاک|گزارش|عکس|ویدیو|فایل|مدیا|استوری|وضعیت/i.test(text)) {
    return "رسانهٔ خصوصی E2EE است. گروه، جامعه، کانال و استوری زنده‌اند. پست کانال و استوری روی سرور است تا مخاطبان مجاز ببینند؛ چت خصوصی داخل کلید دستگاه می‌ماند.";
  }
