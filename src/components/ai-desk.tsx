...
type Msg = { id: string; role: "user" | "assistant"; text: string; imageSvg?: string | null; feedback?: string | null };
      ...
      <aside className="w-full border-b border-white/10 p-3 md:w-64 md:border-b-0 md:border-e">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] opacity-60">دستیار داخلی — نه حقیقت قطعی</p>
          </div>
        </div>
      ...
      <section className="flex min-h-0 flex-1 flex-col">
        ...
        >
          <div className="flex flex-wrap gap-1">
            {["translate", "summarize", "write", "rewrite", "image", "ocr", "file"].map((intent) => (
          ...
          <div className="flex gap-2">
            <Input value={text} onChange={(e) => setText(e.target.value)} placeholder="از نیکسو AI بپرس…" className="flex-1" />
            {busy ? (
